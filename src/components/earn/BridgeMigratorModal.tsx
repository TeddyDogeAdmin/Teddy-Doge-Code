...
import { TokenAmount, Pair } from 'teddyswap-sdk'
      ...
      {attempting && !hash && (
        <LoadingView onDismiss={wrappedOnDismiss}>
          <AutoColumn gap="12px" justify={'center'}>
            ...
            <TYPE.body fontSize={20}>{parsedAmount?.toSignificant(4)} PZL</TYPE.body>
          </AutoColumn>
        </LoadingView>
      )}
      {attempting && hash && (
        <SubmittedView onDismiss={wrappedOnDismiss} hash={hash}>
          <AutoColumn gap="12px" justify={'center'}>
            ...
            {/* TODO: Translate with i18n */}
            <TYPE.body fontSize={20}>Migrated {parsedAmount?.toSignificant(4)} PZL</TYPE.body>
          </AutoColumn>
        </SubmittedView>
      )}
    </Modal>
